...
public class HttpFileHandler extends HttpHackQdZipHandler {
	private final static String TAG = "HttpFileHandler";
	private final static String QDZIP_PATTER = ".*\\.zip";
	...
	public void handle(HttpRequest request, HttpResponse response,HttpContext context) throws HttpException, IOException {
		...
		String target = URLDecoder.decode(uri,"UTF-8");
		Logdeal.D(TAG,"handle...uri:" + uri + ",target:" + target);
		if(target.matches(QDZIP_PATTER)){
